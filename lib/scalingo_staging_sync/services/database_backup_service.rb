...
module ScalingoStagingSync
  module Services
    class DatabaseBackupService
      ...
      include Support::ArchiveHandler

      # Import error classes from BackupService module
      BackupError = Integrations::BackupService::BackupError
      AddonNotFoundError = Integrations::BackupService::AddonNotFoundError
      BackupNotFoundError = Integrations::BackupService::BackupNotFoundError
      DownloadError = Integrations::BackupService::DownloadError
      ...
      def initialize(source_app, temp_dir, logger: Rails.logger, options: {})
        ...
        @api_client = Integrations::ScalingoApiClient.new(source_app, logger: logger)
        @file_downloader = Support::FileDownloader.new(logger: logger, timeout: options[:timeout])
